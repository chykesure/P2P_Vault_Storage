 ...
 * FIX: Convert Uint8Array -> base64 string before encrypt.
...
export function useFileVault(): UseFileVaultReturn {
  ...
  /**
   * Upload: Uint8Array -> base64 -> encrypt -> IPFS -> pin -> index
   */
  const uploadFile = useCallback(
    async (
      ...
      try {
        // Step 1: Convert Uint8Array -> base64 string
        ...
        // Step 2: Encrypt the base64 string (with await!)
        ...
        // Step 5: Save to IPFS-based file index with encryption metadata
  ...
  /**
   * Refresh file list from IPFS index.
   */
