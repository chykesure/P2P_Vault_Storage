...
// Temp address for Expo Go testing (no wallet connected)
...
export function useFileVault(): UseFileVaultReturn {
  ...
  // Use real address or temp address for testing
  ...
  const uploadFile = useCallback(
    async (
      ...
      try {
        ...
        // Step 2: Upload to IPFS (file gets pinned automatically by Pinata)
