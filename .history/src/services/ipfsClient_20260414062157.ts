...
/**
 * Upload via Pinata's JSON pinning API using JWT authentication.
 * Uses JSON body instead of FormData for React Native compatibility.
 */
    ...
    try {
      ...
      if (cid) {
        return {
          ...
          uploadTime: Date.now() - gatewayStartTime,
        };
      }
    } catch (error) {
