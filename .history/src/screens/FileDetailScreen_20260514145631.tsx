 ...
 *
 * FIX: Moved ext/isImage/iconInfo AFTER the null guard.
 *      Previously these ran at top-level when file was null → crash.
 */
...
export function FileDetailScreen({ route }: any) {
  ...
  // ★ FIX: These run ONLY after the null guard — file is guaranteed non-null
  const ext = getFileExtension(file.fileName, file.fileType);
