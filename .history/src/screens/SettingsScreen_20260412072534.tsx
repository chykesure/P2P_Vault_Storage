...
import { CHAIN_DISPLAY_NAMES, getCurrentNetwork } from '@config/network';
...
export function SettingsScreen() {
  ...
  const currentNetworkName = CHAIN_DISPLAY_NAMES[getCurrentNetwork()];
        ...
        <View style={styles.card}>
          <View style={styles.cardRow}>
            ...
            <View style={styles.cardRowInfo}>
              ...
              <Text style={styles.cardRowValue}>{currentNetworkName}</Text>
            </View>
          </View>
          <View style={styles.cardDivider} />
          <View style={styles.cardRow}>
